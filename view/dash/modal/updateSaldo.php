    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formEditSaldo" action="dash/updSaldo.php">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <button id="btnSalvarConta" onclick="updateSaldo('#formEditSaldo', event, 'dash/updSaldo.php');" class="btn btn-primary" data-dismiss="modal">
                                Atualizar
                            </button>
                        </div>
                    </div>
